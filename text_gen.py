...
files = os.listdir("C:\\Users\\Owner\\Desktop\\TikTok Auto\\clips")
for file in files:
    file_path = os.path.join("C:\\Users\\Owner\\Desktop\\TikTok Auto\\clips", file)
...
files = os.listdir("C:\\Users\\Owner\\Desktop\\TikTok Auto\\audios")
for file in files:
    file_path = os.path.join("C:\\Users\\Owner\\Desktop\\TikTok Auto\\audios", file)
    if os.path.isfile(file_path):
      try:
        os.remove(file_path)
      except:
...
files = os.listdir("C:\\Users\\Owner\\Desktop\\TikTok Auto\\voiced")
for file in files:
    file_path = os.path.join("C:\\Users\\Owner\\Desktop\\TikTok Auto\\voiced", file)
    if os.path.isfile(file_path):
      try:
        os.remove(file_path)
      except:
...
for i in range(0,lines):
  ...
  speech.save(f"C:\\Users\\Owner\\Desktop\\TikTok Auto\\audios\\audio number {i}.wav")
  f = CompositeVideoClip([sub_clip,txt])
  f.write_videofile(f"C:\\Users\\Owner\\Desktop\\TikTok Auto\\clips\\clip number {i}.mp4")
  audio = AudioFileClip(f"C:\\Users\\Owner\\Desktop\\TikTok Auto\\audios\\audio number {i}.wav")
  f = VideoFileClip(f"C:\\Users\\Owner\\Desktop\\TikTok Auto\\clips\\clip number {i}.mp4").without_audio()
  voiced = f.set_audio(audio)
  voiced.write_videofile(f"C:\\Users\\Owner\\Desktop\\TikTok Auto\\voiced\\clip number {i}.mp4")
  print("Just finished line: ",i+1," of ",lines)
  audio.close()
  f.close()

clips = os.listdir("C:\\Users\\Owner\\Desktop\\TikTok Auto\\voiced")
file_paths = []
for clip in clips:
    file_paths.append("C:\\Users\\Owner\\Desktop\\TikTok Auto\\voiced\\"+clip)
